...
from espnet2.tasks.asr_wat import ASRWATTask
...
class Speech2Text:
    ...
    def __init__(
        ...
        task = ASRWATTask if not enh_s2t_task else EnhS2TTask
    ...
    def __call__(
        ...
        # b. Forward Encoder
        enc, _ , _,_ = self.asr_model.encode(**batch)
...
def inference(
    ...
    loader = ASRWATTask.build_streaming_iterator(
        data_path_and_name_and_type,
        dtype=dtype,
        batch_size=batch_size,
        key_file=key_file,
        num_workers=num_workers,
        preprocess_fn=ASRWATTask.build_preprocess_fn(speech2text.asr_train_args, False),
        collate_fn=ASRWATTask.build_collate_fn(speech2text.asr_train_args, False),
